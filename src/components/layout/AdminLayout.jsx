...
import { CheckSquare, ClipboardList, Home, LogOut, Menu, Database, ChevronDown, ChevronRight, Zap, FileText, X, Play, Pause, KeyRound, Video, Calendar, Settings, Briefcase } from 'lucide-react'
  ...
  return (
    ...
    >
      ...
      <aside className="hidden w-64 flex-shrink-0 border-r border-blue-200 bg-white md:flex md:flex-col">
        <div className="flex h-20 items-center justify-center border-b border-blue-200 px-4 bg-white">
          <Link
            to="/dashboard/admin"
            className="flex items-center justify-center w-full"
          >
            <img src={sbhLogo} alt="Parekh Sanitary Stores" className="h-16 w-auto object-contain" />
          </Link>
        </div>
                  ...
                  <div>
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <route.icon
                          className={`h-4 w-4 ${route.active ? "text-blue-600" : "text-gray-500"
                            }`}
                        />
                        {route.label}
                      </div>
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-4 md:p-6 pb-20 bg-gradient-to-br from-blue-50 to-purple-50">
          {children}
