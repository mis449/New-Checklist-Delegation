  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const tasksDataMain = tasksToSubmit.map((task, index) => {
        ...
        // Only include taskId if it's NOT a checklist task (since Checklist sheet uses formulas)
        if (formData.taskType !== "checklist") {
          taskObj.taskId = (nextTaskIdMain + index).toString();
        }
      ...
      if (formData.taskType === "checklist" && !isDelegationFrequency) {
        ...
        // Prepare tasks data for UNIQUE sheet
                          ...
                          >
                            <span className="font-medium">
                              ...
                              {formData.frequency === "one-time" ||
                                ...
                                : ` (Will be stored in Checklist & Unique sheets)`}
                            </span>
                            <svg
